...
export default function HomeComp({ data }: any) {
    ...
    return (
      <main>
        ...
        {!load && data.personal_page_sections.sort((a:any, b:any) => a.position - b.position).filter((sections:any) => sections.page_location === 'home').map((page:any, index:number) => (
        <Banner
            key={index}
            style={{
